...
data class Pegawai(var uid:String,var jab:Jabatan,var pwd:String,var nm:String,var almt:String,var tlp:String,var masuk:Boolean,
                   var logs:List<Jejak>,var abs:List<Absen>,var trans:List<Transaksi>)
...
data class Transaksi(var nota:String,var ttd:Pegawai,var ke:Register,var dari:Register,var jum:Uang,var tgl:Date,var waktu:Timestamp,var ket:String)
...
data class SatuanBarang(var barkode:String,var nm:String,var jual:Uang,var beli:Uang,var stok:Long,var bar:Barang)
data class Pasok(var kode:String,var waktu:Timestamp,var catat:Transaksi,var jum:Uang,var sup:Suplier,var hut:Hutang?,var item:List<ItemPasok>)
data class ItemPasok(var brg:SatuanBarang,var qty:Int,var beli:Uang)
data class PasokBS(var kode:String,var waktu:Timestamp,var catat:Transaksi,var jum:Uang,var sup:Suplier,var pas:List<ItemPasokBS>,
                   var back:List<ItemBackBS>)
